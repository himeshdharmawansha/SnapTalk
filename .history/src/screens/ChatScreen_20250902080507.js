      ...
      >
        <View style={styles.container}>
          ...
          <FlatList
            ...
            contentContainerStyle={{ padding: 12, paddingBottom: insets.bottom + 20 }} // Add dynamic bottom inset + extra padding
            onContentSizeChange={() => listRef.current?.scrollToEnd?.({ animated: false })}
          />
          <View style={[styles.inputRow, { paddingBottom: insets.bottom + 20, marginBottom: 10 }]}> {/* Lift input row */}
            <TextInput
              style={styles.input}
              value={text}
