...
import { View, Text, FlatList, TextInput, Pressable, StyleSheet, Dimensions } from 'react-native';
      ...
      >
        <View style={styles.container}>
          ...
          <FlatList
            ...
            contentContainerStyle={{ padding: 12, paddingBottom: Dimensions.get('window').height * 0.1 }} // Add padding to avoid bottom overlap
            onContentSizeChange={() => listRef.current?.scrollToEnd?.({ animated: false })}
          />
          <View style={[styles.inputRow, { marginBottom: 10 }]}> {/* Add margin to lift input above navigation bar */}
            <TextInput
              style={styles.input}
              value={text}
